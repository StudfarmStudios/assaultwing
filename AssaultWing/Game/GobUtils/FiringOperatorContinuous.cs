...
namespace AW2.Game.GobUtils
{
    public class FiringOperatorContinuous : FiringOperator
    {
        ...
        public override bool CanFire
        {
            get
            {
                float neededCharge = Device.FireChargePerSecond * (float)AssaultWingCore.Instance.GameTime.ElapsedGameTime.TotalSeconds;
        ...
        public override bool TryFire()
        {
            ...
            _fireThisFrame = true;
            Device.Charge -= Device.FireChargePerSecond * (float)AssaultWingCore.Instance.GameTime.ElapsedGameTime.TotalSeconds;
            return true;
        }
